  ...
  },
        {
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              "@type": "ListItem",
                              "position": 3,
                              "name": "Cómo calcular la puja máxima en una subasta judicial",
                              "item": "https://activosoffmarket.es/calcular-puja-maxima-subasta"
                    }
          ]
}
      ]
            ...
            <div className="bg-brand-50 border border-brand-100 rounded-2xl p-6 md:p-8 mb-12 shadow-sm not-prose">
                ...
                <ul className="space-y-3">
                    <li className="flex gap-3 text-slate-700">
                        ...
                        <p className="leading-snug">Fija tu límite de puja antes y no te dejes llevar.</p>
                    </li><li className="flex gap-3 text-slate-700">
                        <div className="w-1.5 h-1.5 rounded-full bg-brand-500 mt-2 shrink-0"></div>
                        <p className="leading-snug">Incluye impuestos, reformas y derramas.</p>
                    </li><li className="flex gap-3 text-slate-700">
                        <div className="w-1.5 h-1.5 rounded-full bg-brand-500 mt-2 shrink-0"></div>
                        <p className="leading-snug">Si la puja sube más, abandona la subasta.</p>
                    </li>
                </ul>
            </div>
