...
const AuctionBarcelonaGuide: React.FC = () => {
  ...
  const IMG_HERO = "https://images.unsplash.com/photo-1583422409516-2895a77ef244?auto=format&fit=crop&q=80&w=1200&h=630"; 
  ...
  const schemaData = {
    ...
    "@type": "Article",
    "headline": "Subastas BOE Barcelona: cómo comprar pisos en subasta judicial",
    "description": "Descubre cómo comprar pisos en subasta judicial en Barcelona. Aprende a encontrar oportunidades reales en el portal del BOE, auditar expedientes y pujar con rentabilidad.",
    "author": {
      "@type": "Person",
  ...
  },
        {
          ...
          "itemListElement": [
                    ...
                    },
                    {
                              "@type": "ListItem",
                              "position": 3,
                              "name": "Subastas BOE Barcelona: cómo comprar pisos en subasta judicial",
                              "item": "https://activosoffmarket.es/subastas-barcelona"
                    }
          ]
}
      ]
  ...
  const faqSchema = {
    ...
    "mainEntity": [
      ...
      {
        "@type": "Question",
        "name": "¿Cuánto debo consignar para participar en subastas en Barcelona?",
        "acceptedAnswer": {
          "@type": "Answer",
  ...
  useEffect(() => {
    ...
    document.title = "Subastas BOE Barcelona: cómo comprar pisos en subasta judicial";
    
    const metaDesc = document.querySelector('meta[name="description"]');
    if (metaDesc) metaDesc.setAttribute('content', "Descubre cómo comprar pisos en subasta judicial en Barcelona. Aprende a encontrar oportunidades reales en el portal de subastas del BOE y evitar cargas registrales.");
    ...
    setMeta('og:title', 'Subastas BOE Barcelona: cómo comprar pisos en subasta judicial');
    setMeta('og:description', 'Descubre cómo comprar pisos en subasta judicial en Barcelona. Aprende a encontrar oportunidades reales en el portal de subastas del BOE y evitar cargas registrales.');
      ...
      <header className="bg-white pb-12 border-b border-slate-200">
        <div className="max-w-7xl mx-auto px-6">
            ...
            <h1 className="font-serif text-3xl md:text-5xl lg:text-6xl font-bold text-slate-900 mb-8 leading-tight">
                Subastas BOE Barcelona: cómo comprar pisos en subasta judicial
            </h1>\n
            ...
            <p className="text-lg text-slate-600 mb-8">
              Las subastas BOE en Barcelona ofrecen oportunidades de inversión para adquirir inmuebles con descuentos. Descubre cómo encontrar pisos de bancos y embargos, evaluar el expediente judicial y pujar con seguridad en la capital y el resto de la provincia.
            </p>
            ...
            <div className="bg-slate-50 border border-slate-200 rounded-xl p-6 mb-12">
                ...
                <ul className="grid grid-cols-1 md:grid-cols-2 gap-3 text-sm list-none p-0 m-0">
                    <li className="flex items-center gap-2"><ArrowRight size={14} className="text-brand-500 shrink-0"/><a href="#encontrar-subastas" className="text-slate-700 hover:text-brand-600 transition-colors">Dónde encontrar subastas en Barcelona</a></li>
        ...
        <main className="lg:col-span-8">
            <article className="prose prose-lg prose-slate prose-headings:font-serif prose-headings:font-bold prose-headings:text-slate-900 prose-p:leading-loose text-left max-w-5xl space-y-6 leading-relaxed prose-p:max-w-3xl prose-headings:max-w-3xl prose-li:max-w-3xl">
              ...
              <p className="text-xl leading-relaxed mb-6 font-light first-letter:text-5xl first-letter:font-serif first-letter:font-bold first-letter:text-brand-700 first-letter:mr-3 first-letter:float-left">
                Las subastas pisos Barcelona representan una de las vías más rentables para adquirir propiedades, locales o garajes con descuentos notables sobre el valor de mercado. 
              </p>
              <p className="text-xl leading-relaxed mb-6 font-light">
                Sin embargo, la mayoría de los inversores fracasa en el primer paso: no saben identificar qué activos esconden deudas inasumibles. Participar en subastas en Barcelona exige conocimientos técnicos; un error de análisis en la nota simple o la certificación de cargas puede arruinar todos tus beneficios.
              </p>
                ...
                <div className="bg-brand-50 border border-brand-200 p-8 rounded-2xl my-8 relative overflow-hidden">
                  <div className="relative z-10">
                    <h3 className="text-xl font-bold text-brand-900 mb-4 flex items-center gap-2">
                        ...
                        Radiografía del mercado en Barcelona (Actualizado)
                    </h3>
            ...
            <div className="bg-brand-50 border border-brand-100 rounded-2xl p-6 md:p-8 mb-12 shadow-sm not-prose">
                ...
                <ul className="space-y-3">
                    <li className="flex gap-3 text-slate-700">
                        ...
                        <p className="leading-snug">Mercado muy competitivo en Cataluña.</p>
                    </li><li className="flex gap-3 text-slate-700">
                        <div className="w-1.5 h-1.5 rounded-full bg-brand-500 mt-2 shrink-0"></div>
                        <p className="leading-snug">Altos impuestos (ITP del 10%).</p>
                    </li><li className="flex gap-3 text-slate-700">
                        <div className="w-1.5 h-1.5 rounded-full bg-brand-500 mt-2 shrink-0"></div>
                        <p className="leading-snug">Busca oportunidades en las afueras.</p>
                    </li>
                </ul>
            </div>
...
<h2 id="encontrar-subastas" className="text-3xl font-bold mt-12 mb-6">Dónde encontrar subastas judiciales en Barcelona</h2>
              <p>
                Para localizar subastas de pisos, locales o garajes en la provincia de Barcelona, debes acudir a las fuentes oficiales. Las principales son:
              </p>
              ...
              <p>
                En resumen, si quieres buscar oportunidades en Barcelona, tu principal herramienta de trabajo diaria debe ser el buscador avanzado del portal oficial del BOE.
              </p>

              <h2 id="que-mirar" className="text-3xl font-bold mt-12 mb-6">Qué mirar en las subastas de Barcelona</h2>
              <p>
                Analizar activos en Barcelona requiere poner el foco en tres puntos críticos que la mayoría de compradores pasa por alto:
              </p>
              <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12 mt-8 not-prose">
                ...
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group hover:border-brand-300 transition-colors">
                  ...
                  <p className="text-slate-600 text-sm leading-relaxed m-0">
                    Mucha vulnerabilidad oculta. Ten en cuenta que los plazos de lanzamiento en Barcelona pueden superar los 12 meses ampliamente.
                  </p>
                </div>
                <div className="bg-white p-6 rounded-2xl border border-slate-200 shadow-sm relative overflow-hidden group hover:border-brand-300 transition-colors">
              ...
              <div className="p-6 bg-brand-50 rounded-2xl mb-12 flex flex-col sm:flex-row items-center justify-between gap-6 border border-brand-100 shadow-sm">
                  ...
                  <Link to={ROUTES.ANALIZAR_SUBASTA} className="whitespace-nowrap bg-brand-600 text-white font-bold px-8 py-4 rounded-xl hover:bg-brand-700 transition-all shadow-md shadow-brand-500/20 text-base flex items-center gap-2 w-full sm:w-auto justify-center">
                     Analizar subasta en Barcelona <Search size={18} />
                  </Link>
              </div>

              
<GuideMobileCTA />
<h2 id="rentabilidad" className="text-3xl font-bold mt-12 mb-6">Cómo calcular la rentabilidad de una subasta en Barcelona</h2>
              <p className="mb-6">
                Para calcular correctamente la rentabilidad de una subasta en Cataluña se sitúa generalmente en estrictamente necesario incluir en tus números:
              </p>
              <ul className="list-disc pl-6 space-y-3 mb-8">
                <li>El <strong>precio de adjudicación</strong> (tu puja ganadora).</li>
                <li>Los <strong>impuestos (ITP)</strong>, que en la provincia de Barcelona es del 10% con carácter general para segunda mano.</li>
              ...
              <h2 id="ejemplo-calculo" className="text-3xl font-bold mt-12 mb-6">Ejemplo real de cálculo en Barcelona</h2>
              <p>
              ...
              <div className="bg-white border border-slate-200 p-8 rounded-2xl shadow-sm my-8">
                <ul className="space-y-4 text-slate-700 font-medium list-none pl-0 m-0">
                    ...
                    <li className="flex justify-between border-b border-slate-100 pb-3">
                        <span>ITP Cataluña (10%) + Honorarios:</span> <span>15.000€</span>
                    </li>
              ...
              <h2 id="faq" className="text-3xl font-bold mt-12 mb-6">Preguntas frecuentes sobre comprar piso en subasta en Barcelona</h2>
              ...
              <div className="space-y-6 my-8">
                ...
                <div className="bg-white border border-slate-200 p-6 rounded-xl">
                  <h3 className="font-bold text-lg text-slate-900 mb-2 flex items-center gap-2">
                    <HelpCircle size={20} className="text-brand-600 shrink-0" />
                    ¿Cuánto debo consignar para participar en subastas en Barcelona?
                  </h3>
                  <p className="text-slate-600 m-0">
              ...
              <div className="my-16 bg-white p-8 rounded-2xl border border-slate-200 shadow-sm">
                <h2 id="analizar-correctamente" className="text-3xl font-bold mb-6 text-slate-900 border-b border-slate-100 pb-4">Cómo analizar una subasta en Barcelona correctamente</h2>
                
                <p className="text-slate-700 mb-6 leading-relaxed">
                  Para tener éxito en el mercado de subastas de Barcelona, la intuición no sirve. Necesitas auditar la operación de forma fría y profesional. La mayoría de postores se fijan en el descuento aparente y olvidan que están comprando "a cuerpo cierto", asumiendo deudas y ocupantes.
                </p>
                ...
                <p className="text-slate-700 mb-6 leading-relaxed">
                  Suma siempre el pago del ITP (10% en Barcelona), los posibles recibos impagados del IBI, las deudas de comunidad (vitales en edificios del centro), así como el coste de un procedimiento de desahucio y cerrajero en caso de estar la vivienda habitada por terceros.
                </p>
                ...
                <ul className="space-y-2 list-none p-0 m-0">
                        ...
                        <li>
                            <a href="#encontrar-subastas" className="group flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 transition-colors border border-transparent">
                                <span className="text-slate-600 text-sm font-medium group-hover:text-brand-700">Dónde encontrar subastas judiciales en Barcelona</span>
                        ...
                        <li>
                            <a href="#que-mirar" className="group flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 transition-colors border border-transparent">
                                <span className="text-slate-600 text-sm font-medium group-hover:text-brand-700">Qué mirar en las subastas de Barcelona</span>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity group-hover:text-brand-500"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </a>
                        </li>
                        <li>
                            <a href="#rentabilidad" className="group flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 transition-colors border border-transparent">
                                <span className="text-slate-600 text-sm font-medium group-hover:text-brand-700">Cómo calcular la rentabilidad de una subasta en Barcelona</span>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity group-hover:text-brand-500"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </a>
                        </li>
                        <li>
                            <a href="#ejemplo-calculo" className="group flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 transition-colors border border-transparent">
                                <span className="text-slate-600 text-sm font-medium group-hover:text-brand-700">Ejemplo real de cálculo en Barcelona</span>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity group-hover:text-brand-500"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </a>
                        </li>
                        <li>
                            <a href="#faq" className="group flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 transition-colors border border-transparent">
                                <span className="text-slate-600 text-sm font-medium group-hover:text-brand-700">Preguntas frecuentes sobre comprar piso en subasta en Barcelona</span>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity group-hover:text-brand-500"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </a>
                        </li>
                        <li>
                            <a href="#analizar-correctamente" className="group flex items-center justify-between p-2 rounded-lg hover:bg-slate-50 transition-colors border border-transparent">
                                <span className="text-slate-600 text-sm font-medium group-hover:text-brand-700">Cómo analizar una subasta en Barcelona correctamente</span>
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="text-slate-300 opacity-0 group-hover:opacity-100 transition-opacity group-hover:text-brand-500"><polyline points="9 18 15 12 9 6"></polyline></svg>
                            </a>
                        </li>
                </ul>
